...
::: info
Modern application workflows typically involve some sort of continuous integration and continuous deployment (CI/CD)
process. This guide will help you set up a continuous deployment pipeline for your PHP application, independent of the
CI/CD tool you choose.
:::
...
- `DEPLOIO_APP_NAME`: The name of the PHP application in Deploio.
...
You need to install the `nctl` command line tool into your CI/CD tool.
...
::: warning
In this example, you are using the git revision of the current commit to deploy the application. This works in most
...
The script provided above is a rather basic example of how you can deploy your PHP application and thus has some
flaws:
