...
set up Redis, you can follow the instructions [here](key-value-storage).
:::
...
Do you need to **configure Continuous Deployment**? Proceed to the [next step](./continuous-deployment).
