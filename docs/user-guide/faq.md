...
## How to deploy private Git submodules or repository-dependencies?

The credentials which work for your main git repo must be setup by you to also work for
your sub-repo or submodule.
