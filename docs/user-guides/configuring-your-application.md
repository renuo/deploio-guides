...
If you are coming from Heroku, you can use the script [here](migrating_from_other_platforms#retrieving-environment-variables) to retrieve your environment variables in the format required by Deploio.
