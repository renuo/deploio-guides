...
description: Show the user how to set up nctl with an account, provide some general information about nctl and how it links to Deploio, as well as information on the structure of projects/applications etc. Basically get them in a position where they can then start deploying their application.
---
