---
title: Dependencies and Add-Ons
sidebar_position: 4
---
...
Deploio supports a variety of databases, including MySQL, MariaDB and PostgreSQL. You can find more information on the different databases available [here](https://nine.ch/products/databases/) and information about pricing [here](https://docs.nine.ch/docs/on-demand-databases/). 

##### Database creation settings (retention policy etc.) 

[//]: # (TODO: do we actually want to show how to create a database here? Or will this go somewhere else?)

##### Backup and restore (e.g., snapshots).
