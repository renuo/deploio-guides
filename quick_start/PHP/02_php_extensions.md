---
title: Handling PHP extensions
description: Learn how to manage PHP extensions for your PHP applications with Deploio
id: php_extensions
...
If you need extensions that are not defined in the above-mentioned files, you will need to [provide your own Dockerfile](../Docker/01_create_app).
