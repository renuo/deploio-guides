---
id: create_database
title: Create a Database for Your PHP Application
description: Learn how to create a database for your PHP application with Deploio
...
:::note
If you do not use Doctrine or otherwise want to do something differently, make sure that your IP is allowed to connect
