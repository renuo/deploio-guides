...
description: Learn how to configure the CD for your PHP application.
...
- A running Deploio PHP application. If you haven't deployed your PHP application yet, follow
  the [Create a PHP Application](./01_create_app.md) guide.
...
[installation documentation](/documentation/getting_started#installing-nctl).
