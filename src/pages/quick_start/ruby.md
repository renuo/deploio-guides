...
You can see more information about setting up the `nctl` command line [here](https://docs.nine.ch/docs/nctl/nctl-docs).
...
[//]: # (TODO: I'm not sure about this - I changed after Lukas commented but I think it's messed up)
...
[//]: # (TODO: can these be checkable or ticks or something?)
